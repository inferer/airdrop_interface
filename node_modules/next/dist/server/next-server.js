...
class NextNodeServer extends _baseServer.default {
    ...
    async proxyRequest(req, res, parsedUrl, upgradeHead) {
        ...
        const proxy = new _httpProxy.default({
            ...
            proxyTimeout: upgradeHead && this.renderOpts.dev ? undefined : 30000
        });
   ...
   */ getMiddleware() {
        ...
        const rootMiddleware = manifest == null ? void 0 : (ref = manifest.middleware) == null ? void 0 : ref["/"];
        if (!rootMiddleware) {
            return;
        }
        return {
    ...
    getEdgeRoutes() {
        ...
        return edgeFunctions.concat(middleware ? [
            middleware
        ] : []);
    }
    /**
   ...
   */ async ensureMiddleware() {}
    async ensureEdgeFunction(_pathname) {}
    /**
        ...
        if (!result) {
            ...
            for (let [key, value] of allHeaders){
                ...
                if (key.toLowerCase() === "set-cookie") {
                    (0, _requestMeta).addRequestMeta(params.request, "_nextMiddlewareCookie", Array.isArray(value) ? value : [
                        value
                    ]);
                }
            }
