...
class Server {
    ...
    async handleRequest(req, res, parsedUrl) {
        try {
            ...
            const _res = res.originalResponse;
                ...
                try {
                    ...
                    if (pageIsDynamic || didRewrite) {
                        ...
                        utils.normalizeVercelUrl(req, true, [
                            ...rewriteParamKeys,
                            ...Object.keys(((ref4 = utils.defaultRouteRegex) == null ? void 0 : ref4.groups) || {}), 
                        ]);
                    }
   ...
   */ async handleApiRequest(req, res, pathname, query) {
    ...
    async renderToResponseWithComponents({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        const isServerComponent = !!((ref5 = components.ComponentMod) == null ? void 0 : ref5.__next_rsc__);
        ...
        if (opts.supportsDynamicHTML === true) {
            ...
            const isSupportedDocument = typeof ((ref9 = components.Document) == null ? void 0 : ref9.getInitialProps) !== "function" || // When concurrent features is enabled, the built-in `Document`
        ...
        resolvedUrlPathname = (0, _normalizeLocalePath).normalizeLocalePath((0, _removeTrailingSlash).removeTrailingSlash(resolvedUrlPathname), (ref8 = this.nextConfig.i18n) == null ? void 0 : ref8.locales).pathname;
