...
export default function RemoveLiquidity() {
  ...
  const [approval, approveCallback] = useApproveCallback(parsedAmounts[Field.LIQUIDITY], chainId && getRouterAddress(chainId))
  ...
  async function onAttemptToApprove() {
    ...
    const message = {
      owner: account,
      spender: chainId && getRouterAddress(chainId),
