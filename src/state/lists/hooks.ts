...
import { AIRLABEL_TOKEN_LIST_URL, AIR_TOKEN_LIST_URL, ALGLABEL_TOKEN_LIST_URL, DEFAULT_TOKEN_LIST_URL } from '../../constants/lists'
...
export function useUSDTTokenList(): TokenAddressMap {
